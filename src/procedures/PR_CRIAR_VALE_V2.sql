...
AS
 ...
 -- AND VL.CPF ='74762540668'
  ...
  SELECT X1.* FROM (SELECT X.*,CASE
        ...
        WHEN carga_horaria <'0800'AND X.HR_1
        BETWEEN '1300'AND '1729'  THEN 'TURNO_TARDE'
        WHEN carga_horaria <'0800'AND X.HR_1
        BETWEEN '1730'AND '2359' THEN 'TURNO_NOITE'
        WHEN carga_horaria <'0800'AND X.HR_1
    ...
    ORDER BY x1.carga_horaria desc, X1.hr_1 )
WHERE ROWNUM =1
)
    LOOP
    SOMA      :=0;
    DBMS_Output.PUT_LINE('Entrou no loop');
    DBMS_Output.PUT_LINE(X1.COD_ESCALA);
    DBMS_Output.PUT_LINE(X1.TURNO);
    DBMS_Output.PUT_LINE(X1.CARGA_HORARIA);
    DBMS_Output.PUT_LINE(X1.CARGO);
    IF ((X1.TURNO='TURNO_CHEIO' AND X1.CARGA_HORARIA>='0800') OR ( X1.CARGO IN ('000000000001766','000000000001763','000000000001768','000000000001767','000000000001765') AND X1.CARGA_HORARIA>='0700' )) THEN
      ...
      END AS TURNO
        ...
        ORDER BY EL.DT_INICIO_TROCA
           ...
           LOOP
              ...
              DBMS_Output.PUT_LINE(X1.hr_2 ||' - ' ||EL.hr_1);
        IF   ( EL.hr_1 - X1.hr_2 <= 200 ) or ( X1.TURNO='TURNO_CHEIO' AND X1.CARGA_HORARIA>='0800' ) THEN
      ...
      ORDER BY X2.DT_INICIO_TROCA
          ...
          IF   ( X2.hr_1 - X1.hr_2  <= 200 ) or ( X1.TURNO='TURNO_CHEIO' AND X1.CARGA_HORARIA>='0800' ) THEN
