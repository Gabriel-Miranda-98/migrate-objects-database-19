  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "ARTERH"."PR_PS_PROCESSAR_MOV_CS" (PCODIGO_EMPRESA CHAR, PANO_MES_REFERENCIA DATE, PDATA_CORTE DATE, PID_ARQUIVO NUMBER, PACAO NUMBER ) as
