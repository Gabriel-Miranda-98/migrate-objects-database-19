  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "PONTO_ELETRONICO"."PRG19_P4_TOT_SIT_PONTO_ARTE" (DATA_INICIO IN DATE, DATA_FIM IN DATE) AS
BEGIN
...
)DES ON DES.CODIGO_EMPRESA = X.CODIGO_EMPRESA AND DES.TIPO_CONTRATO = X.TIPO_CONTRATO AND DES.CODIGO_CONTRATO = X.CODIGO_CONTRATO
--FIM --NOVO EM 11/3/22
