  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "ARTERH"."PR_PS_PROCESSAR_CONCESSAO_PBH" (PCODIGO_EMPRESA CHAR, PTIPO_CONTRATO CHAR,PID_ARQUIVO NUMBER, PACAO NUMBER ) as
--EXECUTE ARTERH.PR_PS_PROCESSAR_CONCESSAO_NEW(:GLB_EMPRESA,:GLB_TIPO_CONTRATO, :texto_1, :texto_2);
/*
