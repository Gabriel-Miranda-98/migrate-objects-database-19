...
--Kellysson em 1/4/24 email (ABONO CAMPANHA VACINACAO)
...
--Kellysson em 1/4/24 email (ABONO CAMPANHA VACINACAO) alterado codigo situacao de ponto de 0578 para 1233-ABONO CAMPANHAS VACINAÇÃO
dbms_output.put_line('--GRAVANDO SITUACAO DE PONTO COM VALIDACAO INTEGRAL TABELA SAV1 CONSIDERANDO MARCACOES: 1233-ABONO CAMPANHAS VACINAÇÃO');
dbms_output.put_line('DELETE RHPONT_RES_SIT_DIA WHERE TIPO_APURACAO = ''F'' AND CODIGO_EMPRESA = ''' ||C1.EMPRESA ||''' AND TIPO_CONTRATO = ''' || C1.TIPO_CONTRATO ||''' AND CODIGO_CONTRATO = '''|| C1.MATRICULA ||''' AND TRUNC(DATA) = TO_DATE('''|| trunc(C1.DATA) ||''',''DD/MM/YYYY'') AND CODIGO_SITUACAO = ''1233''; COMMIT;' );  
DELETE ARTERH.RHPONT_RES_SIT_DIA WHERE TIPO_APURACAO = 'F' AND CODIGO_EMPRESA = C1.EMPRESA AND TIPO_CONTRATO = C1.TIPO_CONTRATO AND CODIGO_CONTRATO = C1.MATRICULA AND TRUNC(DATA) = C1.DATA AND CODIGO_SITUACAO = '1233'; COMMIT;  
dbms_output.put_line('INSERT INTO RHPONT_RES_SIT_DIA (CODIGO_EMPRESA, TIPO_CONTRATO, CODIGO_CONTRATO, DATA, CODIGO_SITUACAO, REF_HORAS, TIPO_APURACAO, DT_ULT_ALTER_USUA, LOGIN_USUARIO, FORCA_SITUACAO, TEXTO_ASSOCIADO) VALUES ('''||C1.EMPRESA ||''','''|| C1.TIPO_CONTRATO ||''','''|| C1.MATRICULA ||''', TO_DATE('''|| trunc(C1.DATA) ||''',''DD/MM/YYYY''),''1233'','|| vSTRING ||', ''F'', SYSDATE, ''IFPONTO'',''N'',''SCRIPT FECHAMENTO IFPONTO(grava_sobreaviso_campanha_vacinacao_v1.sql)''); COMMIT;' );  
INSERT INTO ARTERH.RHPONT_RES_SIT_DIA (CODIGO_EMPRESA, TIPO_CONTRATO, CODIGO_CONTRATO, DATA, CODIGO_SITUACAO, REF_HORAS, TIPO_APURACAO, DT_ULT_ALTER_USUA, LOGIN_USUARIO, FORCA_SITUACAO, TEXTO_ASSOCIADO) VALUES (C1.EMPRESA, C1.TIPO_CONTRATO, C1.MATRICULA, C1.DATA,'1233', vSTRING, 'F', SYSDATE, 'IFPONTO','N','PRG11_CAMPANHA_VACINACAO'); COMMIT;
vLOG := vLOG||'-'||'GRAVANDO SITUACAO DE PONTO COM VALIDACAO INTEGRAL TABELA SAV4 CONSIDERANDO MARCACOES: 1233-ABONO CAMPANHAS VACINAÇÃO';
vLOG_ERRO_REGRA_LOCAL_MARCA := NULL;
vCAMPO_4 := '*GRAVANDO SITUACAO DE PONTO COM VALIDACAO INTEGRAL TABELA SAV4 CONSIDERANDO MARCACOES: 1233-ABONO CAMPANHAS VACINAÇÃO';
...
--Kellysson em 1/4/24 email (ABONO CAMPANHA VACINACAO) alterado codigo situacao de ponto de 0578 para 1233-ABONO CAMPANHAS VACINAÇÃO
dbms_output.put_line('--GRAVANDO SITUACAO DE PONTO COM VALIDACAO PARCIAL TABELA SAV1 MARCACOES DIRETO NO ESPELHO: 1233-ABONO CAMPANHAS VACINAÇÃO');
dbms_output.put_line('DELETE RHPONT_RES_SIT_DIA WHERE TIPO_APURACAO = ''F'' AND CODIGO_EMPRESA = ''' ||C1.EMPRESA ||''' AND TIPO_CONTRATO = ''' || C1.TIPO_CONTRATO ||''' AND CODIGO_CONTRATO = '''|| C1.MATRICULA ||''' AND TRUNC(DATA) = TO_DATE('''|| trunc(C1.DATA) ||''',''DD/MM/YYYY'') AND CODIGO_SITUACAO = ''1233''; COMMIT;' );  
DELETE ARTERH.RHPONT_RES_SIT_DIA WHERE TIPO_APURACAO = 'F' AND CODIGO_EMPRESA = C1.EMPRESA AND TIPO_CONTRATO = C1.TIPO_CONTRATO AND CODIGO_CONTRATO = C1.MATRICULA AND TRUNC(DATA) = C1.DATA AND CODIGO_SITUACAO = '1233'; COMMIT;  
dbms_output.put_line('INSERT INTO RHPONT_RES_SIT_DIA (CODIGO_EMPRESA, TIPO_CONTRATO, CODIGO_CONTRATO, DATA, CODIGO_SITUACAO, REF_HORAS, TIPO_APURACAO, DT_ULT_ALTER_USUA, LOGIN_USUARIO, FORCA_SITUACAO, TEXTO_ASSOCIADO) VALUES ('''||C1.EMPRESA ||''','''|| C1.TIPO_CONTRATO ||''','''|| C1.MATRICULA ||''', TO_DATE('''|| trunc(C1.DATA) ||''',''DD/MM/YYYY''),''1233'','|| vSTRING ||', ''F'', SYSDATE, ''IFPONTO'',''N'',''SCRIPT FECHAMENTO IFPONTO(grava_sobreaviso_campanha_vacinacao_v1.sql)''); COMMIT;' );  
INSERT INTO ARTERH.RHPONT_RES_SIT_DIA (CODIGO_EMPRESA, TIPO_CONTRATO, CODIGO_CONTRATO, DATA, CODIGO_SITUACAO, REF_HORAS, TIPO_APURACAO, DT_ULT_ALTER_USUA, LOGIN_USUARIO, FORCA_SITUACAO, TEXTO_ASSOCIADO) VALUES (C1.EMPRESA, C1.TIPO_CONTRATO, C1.MATRICULA, C1.DATA,'1233', vSTRING , 'F', SYSDATE, 'IFPONTO','N','PRG11_CAMPANHA_VACINACAO'); COMMIT;  
vLOG := vLOG||'-'||'GRAVANDO SITUACAO DE PONTO COM VALIDACAO PARCIAL TABELA SAV1 MARCACOES DIRETO NO ESPELHO: 1233-ABONO CAMPANHAS VACINAÇÃO';
vCAMPO_4 :='*GRAVANDO SITUACAO DE PONTO COM VALIDACAO PARCIAL TABELA SAV1 MARCACOES DIRETO NO ESPELHO: 1233-ABONO CAMPANHAS VACINAÇÃO';
