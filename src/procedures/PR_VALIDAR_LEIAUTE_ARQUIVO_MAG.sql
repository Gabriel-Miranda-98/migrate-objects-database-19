  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "ARTERH"."PR_VALIDAR_LEIAUTE_ARQUIVO_MAG" (IDENTIFICADOR_ARQUIVO NUMBER) as
...
BEGIN
    ...
    vIS_ARQUIVO := INTERFACE_ARQUIVO(null,null,null,null,null,null);
     ...
     CASE WHEN pTIPO_ARQUIVO = ARQUIVO_CONCESSOES THEN
		     ...
		     WHEN pTIPO_ARQUIVO = ARQUIVO_MAG_PBH THEN
              vIS_ARQUIVO.TIPO_ARQUIVO := pTIPO_ARQUIVO;
              vIS_ARQUIVO.DESCRICAO_TIPO_ARQUIVO := 'ARQUIVO_MAG_PBH';
              vIS_ARQUIVO.CARACTERE_SEPARADOR := null;
              vIS_ARQUIVO.QTDE_CAMPOS := 11;
              ...
              I_S(vCONTADOR).CAMPO := 'ANO';                  I_S(vCONTADOR).TAMANHO_IS :=  4;  I_S(vCONTADOR).TAMANHO :=  4;  I_S(vCONTADOR).TIPO_IS := TIPO_NUMERICO;     I_S(vCONTADOR).TIPO := TIPO_NUMERICO;     I_S(vCONTADOR).NULO := NAO; vCONTADOR := vCONTADOR + 1;
              I_S(vCONTADOR).CAMPO := 'MES_REFERENCIA';       I_S(vCONTADOR).TAMANHO_IS :=  2;  I_S(vCONTADOR).TAMANHO :=  2;  I_S(vCONTADOR).TIPO_IS := TIPO_NUMERICO;     I_S(vCONTADOR).TIPO := TIPO_NUMERICO;     I_S(vCONTADOR).NULO := NAO; vCONTADOR := vCONTADOR + 1;
              I_S(vCONTADOR).CAMPO := 'INDICADOR_EMPRESA';    I_S(vCONTADOR).TAMANHO_IS :=  2;  I_S(vCONTADOR).TAMANHO :=  2;  I_S(vCONTADOR).TIPO_IS := TIPO_NUMERICO;     I_S(vCONTADOR).TIPO := TIPO_NUMERICO;     I_S(vCONTADOR).NULO := NAO; vCONTADOR := vCONTADOR + 1;
              I_S(vCONTADOR).CAMPO := 'CODIGO_EMPRESA';       I_S(vCONTADOR).TAMANHO_IS :=  4;  I_S(vCONTADOR).TAMANHO :=  4;  I_S(vCONTADOR).TIPO_IS := TIPO_NUMERICO;     I_S(vCONTADOR).TIPO := TIPO_NUMERICO;     I_S(vCONTADOR).NULO := NAO; vCONTADOR := vCONTADOR + 1;
              I_S(vCONTADOR).CAMPO := 'CODIGO_CONTRATO';      I_S(vCONTADOR).TAMANHO_IS :=  15;  I_S(vCONTADOR).TAMANHO := 15; I_S(vCONTADOR).TIPO_IS := TIPO_ALFANUMERICO; I_S(vCONTADOR).TIPO := TIPO_ALFANUMERICO; I_S(vCONTADOR).NULO := NAO; vCONTADOR := vCONTADOR + 1;
              ...
              I_S(vCONTADOR).CAMPO := 'TIPO_PARTICIPANTE';    I_S(vCONTADOR).TAMANHO_IS :=  1;  I_S(vCONTADOR).TAMANHO :=  1;  I_S(vCONTADOR).TIPO_IS := TIPO_ALFANUMERICO; I_S(vCONTADOR).TIPO := TIPO_ALFANUMERICO; I_S(vCONTADOR).NULO := NAO; vCONTADOR := vCONTADOR + 1;
              I_S(vCONTADOR).CAMPO := 'PERSENT_FACULTATIVO';  I_S(vCONTADOR).TAMANHO_IS :=  5;  I_S(vCONTADOR).TAMANHO :=  5;  I_S(vCONTADOR).TIPO_IS := TIPO_NUMERICO;     I_S(vCONTADOR).TIPO := TIPO_NUMERICO;     I_S(vCONTADOR).NULO := NAO; vCONTADOR := vCONTADOR + 1;
              I_S(vCONTADOR).CAMPO := 'PERSENT_PATROCINADO';  I_S(vCONTADOR).TAMANHO_IS :=  5;  I_S(vCONTADOR).TAMANHO :=  5;  I_S(vCONTADOR).TIPO_IS := TIPO_NUMERICO;     I_S(vCONTADOR).TIPO := TIPO_NUMERICO;     I_S(vCONTADOR).NULO := NAO; vCONTADOR := vCONTADOR + 1;
              I_S(vCONTADOR).CAMPO := 'PERSENT_PATROCINADOR'; I_S(vCONTADOR).TAMANHO_IS :=  5;  I_S(vCONTADOR).TAMANHO :=  5;  I_S(vCONTADOR).TIPO_IS := TIPO_NUMERICO;     I_S(vCONTADOR).TIPO := TIPO_NUMERICO;     I_S(vCONTADOR).NULO := NAO; vCONTADOR := vCONTADOR + 1;
              I_S(vCONTADOR).CAMPO := 'VALOR_APORTE_OPCIONAL';I_S(vCONTADOR).TAMANHO_IS :=  8;  I_S(vCONTADOR).TAMANHO :=  8;  I_S(vCONTADOR).TIPO_IS := TIPO_NUMERICO;     I_S(vCONTADOR).TIPO := TIPO_NUMERICO;     I_S(vCONTADOR).NULO := NAO; vCONTADOR := vCONTADOR + 1;
