  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "ARTERH"."NAO_UTILIZAR" ("COD_PLANO", "COD_ORG", "MATRICULA_SEGURADO", "DIGITO_MATRICULA", "CPF_SEGURADO", "DATA_ADMISSAO", "COD_LOTACAO", "COD_LOTACAO_SUPERIOR", "DATA_DESLIGAMENTO", "CODIGO_SITUACAO", "PRIMEIRO_EMPREGO") AS 
  SELECT 
