  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "ARTERH"."ENDERECO_ATIVOS" ("COD_ORG", "MATRICULA", "CPF", "TIPO_LOGRADOURO", "LOGRADOURO", "NUMERO", "COMPLEMENTO", "BAIRRO", "MUNICIPIO", "UF", "CEP", "CAIXA_POSTAL", "DATA_CADASTRO") AS 
  SELECT 
  ...
  TO_NUMBER(SUBSTR(CO.CODIGO,5,10)) ||
	...
	THEN 7
	ELSE to_number(SUBSTR(CO.CODIGO,15,1))END AS MATRICULA,
  ...
  NVL(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(TRANSLATE(TRIM(EP.NUMERO),'ABCDEFGHIJKLMNOPQRSTUVXYWZabcdefghijklmnopqrstuvxywz',' '),' ',''),',',''),'/',''),'-',''),'.',''),':',''),'0') AS NUMERO,
  ...
  TO_CHAR(ANO_MES_REFERENCIA, 'YYYYMMDD') AS DATA_CADASTRO
...
AND (CO.CODIGO < '000000099999999' AND CO.CODIGO NOT IN('000000000777777','000000000823701','000000000833014','000000000866265','000000000747428','000000000190072','000000000420534'))
