  ...
  SELECT 
    ...
    END AS COD_ORG,
        TO_NUMBER(SUBSTR(CO.CODIGO, 5,10)) ||CASE WHEN SUBSTR(CO.CODIGO, 15,1) != 'X' THEN TO_NUMBER(SUBSTR(CO.CODIGO, 15,1)) ELSE 7 END AS MATRICULA,
         ...
         TO_CHAR(PE.DATA_NASCIMENTO) AS DATA_NASCIMENTO_DEPE,
         TO_CHAR(D.DATA_INICIO) AS INICIO_DEPENDENCIA,
    ...
    ELSE  'U' /*Outros*/
    END AS ESTADO_CIVIL,
         trim(TO_CHAR(D.DATA_FIM)) AS FIM_DEPE,
        ...
        TRIM(TO_CHAR(PE.DATA_EXPEDICAO))AS DATA_EXPEDICAO_RG, 
  ...
  from RHPESS_DEPENDENCIA,RHPESS_PESSOA,RHPESS_CONTRATO   
        ...
        ( rhpess_pessoa.CODIGO_EMPRESA  = RHPESS_CONTRATO.CODIGO_EMPRESA ) and      
              ( RHPESS_CONTRATO.SITUACAO_FUNCIONAL IN('1700','1701','1002'))AND   
              ( RHPESS_CONTRATO.CODIGO_EMPRESA = '1700' ) AND     
  ...
  group by RHPESS_DEPENDENCIA.codigo_contrato,
      ...
      WHERE 
           ...
           AND (CO.CODIGO < '000000001500000' AND CO.CODIGO NOT IN('000000000777777','000000000823701','000000000833014','000000000866265','000000000747428')) /*FALECIDOS PIA*/
           AND CO.SITUACAO_FUNCIONAL IN('1002','1700','1701','6500','6600','5800')
           
   
            AND CO.CODIGO_EMPRESA = '1700'
  ...
  GROUP BY CO.COD_LOCAL1,
   ...
   ORDER BY SUBSTR(CO.CODIGO, 5,10)