  ...
  SELECT 
    ...
    END AS COD_ORG,
        TO_NUMBER(SUBSTR(CO.CODIGO, 5,10)) ||CASE WHEN SUBSTR(CO.CODIGO, 15,1) != 'X' THEN TO_NUMBER(SUBSTR(CO.CODIGO, 15,1)) ELSE 7 END AS MATRICULA,
         ...
         CASE         
          ...
          ELSE 'M'
         END AS SEXO,
         CASE WHEN SUBSTR(PE.C_LIVRE_DESCR12,1,80) IS NULL THEN 'NÃƒO POSSUI NO CADASTRO' ELSE SUBSTR(TRIM(PE.C_LIVRE_DESCR12),1,80) END AS NOME_MAE_DEPE, 
         ...
         CASE PP.TP_RELACIONAMENTO 
          ...
          WHEN '0003' THEN '13' /*UNIÃƒÆ’O ESTÃƒ?VEL*/
          WHEN '0009' THEN '98' /*OUTROS INICIO*/
          WHEN '0015' THEN '18' /*TUTELA*/
          WHEN '0019' THEN '11' /* INVALIDEZ*/
          WHEN '0020' THEN '11' /*INVALIDEZ*/
          WHEN '0021' THEN '16' /* DEPENDÃƒÅ NCIA ECONÃƒâ€¿MICO*/
          WHEN '0025' THEN '16' /*DEPENDÃƒÅ NCIA ECONÃƒâ€¿MICA*/
          WHEN '0005' THEN '16' /* DEPENDÃƒÅ NCIA ECONÃƒâ€¿MICA*/
    ...
    WHEN  PE.ESTADO_CIVIL = '0003'  THEN  'V' /*ViÃƒÂºvo*/
    WHEN  PE.ESTADO_CIVIL = '0009'  THEN  'P' /*Separado*/
    WHEN  PE.ESTADO_CIVIL = '0008'  THEN  'U' /*UniÃƒÂ£o Estavel*/
    WHEN  PE.ESTADO_CIVIL = '0004'  THEN  'P' /*Desquitado*/
    WHEN  PE.ESTADO_CIVIL = '0006'  THEN  'D' /*SeparaÃƒÂ§ÃƒÂ£o Judicial*/
    ELSE  'U' /*Outros*/
    END AS ESTADO_CIVIL,
         trim(TO_CHAR(D.DATA_FIM,'YYYYMMDD')) AS FIM_DEPE,
         NULL AS MOTIVO_FIM_DEPE,/*MOTIVO FIM - NÃƒÆ’O POSSUI*/
        substr(TRIM(PE.CERT_NASCIMENTO),1,20) AS NUMERO_CERTI_NASCIMENTO,
         NULL AS NUMERO_LIVRO,
         NULL AS NUMERO_FOLHA_NASCIMENTO, /*NÃƒÆ’O EXISTE - Numero Livro, Numero Folha Nascimento*/
        ...
        SUBSTR(TRIM(UPPER(NATURALID.DESCRICAO)),1,80) AS NATURALIDADE,    
  ...
  from RHPESS_DEPENDENCIA,RHPESS_PESSOA,RHPESS_CONTRATO   
        ...
        RHPESS_CONTRATO.TIPO_CONTRATO =  RHPESS_DEPENDENCIA.TIPO_CONTRATO and 
              ...
              (RHPESS_DEPENDENCIA.data_inicio <= TO_DATE(add_months(sysdate,(-1))-0) OR RHPESS_DEPENDENCIA.data_inicio IS NULL) AND   
        ( rhpess_pessoa.CODIGO_EMPRESA  = RHPESS_CONTRATO.CODIGO_EMPRESA ) and      
              ( RHPESS_CONTRATO.SITUACAO_FUNCIONAL IN('1700','1701','1002', '1022', '1023', '1024', '1025', '1700','1701','1702',
                                                      '1703','1704','1705','1706','1707', '1002', '1700', '1701, 1710','1715','1800','1850','1900','5000','5001','5002','5003','5004','5005','5006',
  ...
  group by RHPESS_DEPENDENCIA.codigo_contrato,
      ...
      WHERE 
           ...
           AND CO.SITUACAO_FUNCIONAL IN('1700','1701','1002', '1022', '1023', '1024', '1025', '1700','1701','1702',
                                                      '1703','1704','1705','1706','1707', '1002', '1700', '1701, 1710','1715','1800','1850','1900','5000','5001','5002','5003','5004','5005','5006',
                                                      '5008','5009','5011', '5019', '5022','5026','5028','5200','5201','5400','5555','5700','5800',
