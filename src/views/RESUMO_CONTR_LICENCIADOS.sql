  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "ARTERH"."RESUMO_CONTR_LICENCIADOS" ("ANO_MES_REFERENCIA", "COD_ORG", "TIPO_MOVIMENTO", "MATRICULA", "BASE_CALC_CONTRI", "VAL_CONT_BAS_SEG", "VAL_CONT_PATRO_NORM", "VAL_CONT_ADIC_SEG", "VAL_CONT_PATR_ADIC", "REMUNERACAO_TOTAL", "NOME", "COD_PLANO", "SITUACAO_FUNCIONAL", "DATA_PAGAMENTO", "DECIMO_TERCEIRO", "FERIAS", "RESCISAO") AS 
  select   
    ...
    and v.codigo IN('4431', '2171', '202I', '3509', '3510', '4xx2', '4xx3', '4001')
		...
		and c.situacao_funcional in ('5101','5103','5104','5105','5106','5109','5113','5114','5112','5116','5118','6118','6120','5100','5102','5107','5110')
    and m.VALOR_VERBA > 0 
