  ...
  CREATE OR REPLACE EDITIONABLE FUNCTION "ARTERH"."FU_CALCULA_HORARIO" (DIA_OCORRENCIA1 IN VARCHAR2,HORARIO_NORMAL_1 IN VARCHAR2, DIA_OCORRENCIA2 IN VARCHAR2, HORARIO_NORMAL_2 IN VARCHAR2 ,DIA_OCORRENCIA3 IN VARCHAR2 ,HORARIO_NORMAL_3 IN VARCHAR2 ,
...
THEN --- EDUARDO EM 22/11/23 : INCLUINDO LOGICA PARA CALCULO ACIMA DE 24H
...
INTO VJORNADA_TOTAL
 from (
SELECT GRUPO_1+GRUPO_2+GRUPO_3+GRUPO_4  AS JORNADA_TOTAL --- OS GRUPOS VEM DO CÁLCULO DO TIMESTAMP 
